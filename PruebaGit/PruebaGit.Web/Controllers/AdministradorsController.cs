...
namespace PruebaGit.Web.Controllers
{
    public class AdministradorsController : Controller
    {
        ...
        {
            var administradors = db.Administradors.Include(a => a.Nombre);
        ...
        {
            ViewBag.Nombre = new SelectList(db.PostreNuevo, "Id", "Nombre");
            return View();
        }
        ...
        public ActionResult Create(Administrador administrador)
        {
            ...
            ViewBag.Nombre = new SelectList(db.PostreNuevo, "Id", "Nombre", administrador.Nombre);
            return View(administrador);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Id_Usuario,Nombre")] Administrador administrador)
        {
            if (ModelState.IsValid)
            {
